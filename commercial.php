    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                $("#cap_details").html("<p class='text-primary'>"+result.capacity+" Galoons/24 Hours</p>");
    ...
    <div class=" container  row text-info " >
        ...
        <div class="col-lg-4 col-sm-11 ">
            ...
            <div class="shadow row ">
                <span class="h1 text-primary p-3 " id="prod_title"> </span>
            </div>
           ...
           <p style="font-size:18px" class="text-danger mt-4 "> <del id="sprice" style="font-size:1.5em"></del></p>
            ...
            <div class=" row ml-2">
                <input type="hidden" class="col-lg-2 form-control-sm form-control bg-gray-200 " name="item_qty" id="item_qty" min="1" value="1">
            </div>
            <div class="mt-4">
...
<div>
    ...
    <div class="container" >
        ...
        <div id="step_stage" class="row">
            <div class="col border-right border-dark" id="stage_pp">
            ...
            <div class="col border-right border-dark" id="stage_cto">
            ...
            <div class="col border-right  border-dark" id="stage_post">
            ...
            <div class="col border-right border-dark" id="stage_ro">
            ...
            <div class="col border-right border-dark" id="stage_udf">
            ...
            <div class="row">
                <div class="col">
                    <div class="text-primary">
                        <i class="fas fa-2x fa-coins"> Output </i> <span id="cap_details"></span>
                    </div>
