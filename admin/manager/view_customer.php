...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <div>
    ...
    <div class="dropdown ml-2">
        <button class="btn btn-success btn-sm dropdown-toggle rep_button" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Export Customer List
        </button>
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="report/cus_list.php" target="_blank" >All</a>
            <a class="dropdown-item" href="report/cus_list.php?ty=0" target="_blank" >Offline</a>
            <a class="dropdown-item" href="report/cus_list.php?ty=1" target="_blank" >Online</a>
        </div>
    </div>
