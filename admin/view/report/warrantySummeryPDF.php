...
$output .="<h3 class='text-center'>Warranty Summery Report</h3>";
...
$output .="<table class='table small' >
            ...
            $sql2 = "SELECT warr_id, inv_id,cus_fname,cus_lname,warr_date,complete_date,warr_claim, description, status FROM tbl_warrenty warr JOIN tbl_customers cus ON warr.cus_id = cus.cus_id ORDER BY warr_date";
