...
<div class="card mt-3" >
    <h4 class="text-center h4 font-weight-bold text-dark">Purchase to Supplier Report </h4>
...
$(document).ready(function(){
    ...
    $("#btn-export").click(function(){
        ...
        window.open('view/report/purchasetoSupplierbyDatePDF.php?sdate='+sdate+'&edate='+edate,'_blank');
