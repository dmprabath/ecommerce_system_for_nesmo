...
<div class="card mt-3" >
    <h4 class="text-center h4 font-weight-bold text-dark">Order Summery Report </h4>
    ...
    <div class="m-3">
        <table id="ls_report" class="table responsive table-bordered">
            ...
            <tbody id="sum_data">
                <?php 
                    $dbobj  =DB::connect();
                    $sql = "SELECT * FROM tbl_invoice inv JOIN tbl_customers cus ON inv.cus_id = cus.cus_id WHERE inv_date BETWEEN '$sdate' AND '$edate' ORDER BY inv_id ";
...
$(document).ready(function(){
    ...
    $("#btn-export").click(function(){
        ...
        window.open('view/report/ordersummerybydatePDF.php?sdate='+sdate+'&edate='+edate,'_blank');
