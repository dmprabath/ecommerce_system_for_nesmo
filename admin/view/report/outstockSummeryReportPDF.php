...
$date = date("Y-m-d");
$dbobj = DB::connect();
$sql = "SELECT prod_id,prod_modal,cat_name,prod_qty,prod_rlevel FROM tbl_products pro JOIN tbl_category cat ON pro.cat_id = cat.cat_id AND pro.prod_qty='0'  ";
    $output .= "<h4 class='text-center'>Out Stock Report of ".$date ." </h4>";
