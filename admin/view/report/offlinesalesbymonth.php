        ...
        <table id="ls_report" class="table responsive table-bordered">
            ...
            <tbody id="sum_data">
                <?php 
                    ...
                    $sql_data = "SELECT * FROM tbl_invoice inv JOIN tbl_customers cus ON inv.cus_id = cus.cus_id WHERE MONTH(inv_date)= '$month' AND YEAR(inv_date) = '$year' AND inv_type='offline'";
