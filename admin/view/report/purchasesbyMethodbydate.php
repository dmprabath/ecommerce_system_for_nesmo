...
<div class="card mt-3" >
    <h4 class="text-center h4 font-weight-bold text-dark">Purchase Report Using  <?php echo $method;  ?> </h4>
...
$(document).ready(function(){
    ...
    $("#btn-export").click(function(){
        ...
        window.open('view/report/purchasesbyMethodbydatePDF.php?sdate='+sdate+'&edate='+edate+'&method='+method,'_blank');
