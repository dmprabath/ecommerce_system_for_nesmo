...
<div class="card mt-3" >
    <h4 class="text-center h4 font-weight-bold text-primary">Low Stock Summery Report</h4>
    <p class="text-center text-primary">This will provide summury of Low product Quantity</p>
    <div class="d-flex justify-content-between">
      <div class="col-lg-4">
...
$(document).ready(function(){
    ...
    $("#btn-export").click(function(){
        ...
        window.open('view/report/lowstockSummeryReportPDF.php?category='+category,'_blank');
