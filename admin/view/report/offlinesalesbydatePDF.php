...
$output .="<h3 class='text-center'>Offline Order Analysis By Date</h3>";
$output .="<p class='text-center'>From".$sdate." To ".$edate." </p>";
$output .="<table class='mb-3' width='30%'>";

            $dbobj  =DB::connect();
            $sql = "SELECT * FROM tbl_invoice inv JOIN tbl_customers cus ON inv.cus_id = cus.cus_id WHERE inv_type = 'offline' AND inv_date BETWEEN '$sdate' AND '$edate' ORDER BY inv_id";
...
$output .="<table class='table small' >
            ...
            $sql2 = "SELECT * FROM tbl_invoice inv JOIN tbl_customers cus ON inv.cus_id = cus.cus_id WHERE inv_type = 'offline' AND inv_date BETWEEN '$sdate' AND '$edate' ORDER BY inv_id";
