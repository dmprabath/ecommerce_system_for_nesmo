  ...
  <div class="modal-dialog modal-xl" role=document>
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="h3" >Add Accessories</h3>
        </div>
            ...
            <div class="row" >
                <div class="col-lg-6 col-sm-10">
                    ...
                    <div class="form-group row d-none ">
                        ...
                        <div class="col-7" >
                            <input readonly class="col-sm-4 form-control form-control-sm" id="prod_cat" name="prod_cat" value="CAT00003">
                        </div>
                    ...
                    <div class="form-group row" >
                        ...
                        <div class="col">
                            ...
                            <label style="font-size:11px">jpeg, png, jpg (Maximum 5MB)</label>
                        </div>
                    ...
                    <div class=" row">
                        ...
                        <div class="form-group col">
                            ...
                            <p style="font-size: 12px; color:orange">Please use '|' for seperate options ( ex: voltage:220V | metrial: plastic ) </p>
                ...
                <div class="col-lg-6 col-sm-10 ">
                    ...
                    <div class=" row">
                        ...
                        <div class="form-group col-2">
                            <input type="number"  class="emp-select form-control form-control-sm" name="prod_rlevel" id="prod_rlevel" min="1" value="1">
                        </div>
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#prod_dprice").on('keyup',function(){
            var prodprice = $(this).val();
            if(prodprice !="" && !prodprice.match(pricePattern)){
                swal("Sorry","Please type valid price","error");
            }
        });
        ...
        $("#btn_add").click(function(){
            ...
            var url = "lib/mod_product.php?type=addNewItem";
